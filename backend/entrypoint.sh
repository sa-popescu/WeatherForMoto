...
# email-link tokens for /auth/verify-email) still reach Cloud Run logging. That
# is an accepted trade-off: verification tokens are single-use and expire in
# 48 h, and log access is restricted to project members.
set -e
PORT="${PORT:-8000}"
